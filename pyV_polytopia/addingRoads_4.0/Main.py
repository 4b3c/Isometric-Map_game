import pygame, random, math, var, roads, buttons
...
while True:
	...
	road_button.button.hovering(mouse_pos)
	road_button.button.draw(window)
	road_button.toggler(pygame.mouse.get_pressed()[0])
